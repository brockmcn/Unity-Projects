...
[CustomEditor(typeof(AIWayPointNetwork))]//overrides beahvior of aiwaypointnetwork objects
public class AIWaypointNetworkEditor : Editor {
    ...
    private void OnSceneGUI()
    {
        ...
        if (network.DisplayMode == PathDisplayMode.Connections)
        {
            ...
            for (int i = 0; i <= network.Waypoints.Count; i++)
            {
                int index = i != network.Waypoints.Count ? i : 0;//loop back around to first waypoint after last waypoint
