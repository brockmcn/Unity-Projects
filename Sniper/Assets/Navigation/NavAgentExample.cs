...
public class NavAgentExample : MonoBehaviour {
    ...
    void SetNextDestination(bool increment)
    {
        ...
        int nextWaypoint = (CurrentIndex + incStep >= WayPointNetwork.Waypoints.Count) ? 0 : CurrentIndex + incStep;//loops back to first waypoint if the current one is last waypoint
