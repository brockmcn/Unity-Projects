...
public class RealClock : MonoBehaviour {
	...
	void Update () {
        ...
        float hour = GameTime.GetComponent<GameTime>().time.Hour;
        float minute = GameTime.GetComponent<GameTime>().time.Minute;
        float second = GameTime.GetComponent<GameTime>().time.Second;
        float millisecond = GameTime.GetComponent<GameTime>().time.Millisecond;
