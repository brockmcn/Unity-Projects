...
public class DayNightController : MonoBehaviour {
    ...
    void Update() {
        ...
        currentTimeOfDay = (GameObject.Find("GameController").GetComponent<GameTime>().time.Hour * 60 + GameObject.Find("GameController").GetComponent<GameTime>().time.Minute) / secondsInFullDay;
